...
mode is more important than the energy a hop would save.
...
\begin{figure}[H]
    ...
    \caption{Mobility solution: side elevation, plan view, and wheel detail. \small\textit{(Figure drafted with AI assistance.)}}
\end{figure}
...
four drive motors covers breakout torque and gearbox drag at \SI{90}{K}, where stiff lubricant determines the
...
and the sounding cadence set the pace of the traverse, before the drive train ever does.
...
measurements. The mobility architecture is all mine. Diagram generated using Claude Opus 5.}
