...
divide surveying tasks across the main exploration rover and the orbital reconnaissance agents needed to scout terrain
ahead of it. My mission will focus on designing a robust system of agents that can orbit Europa and perform reconnaissance
for a rover traversing the surface in search of a proper drilling site to access the inner layers of the moon. This mission
...
A coordinated multi-agent system deployed to Europa's surface to autonomously characterize the
ice shell and identify an optimal cryobot insertion site, operating without real-time Earth
support.
